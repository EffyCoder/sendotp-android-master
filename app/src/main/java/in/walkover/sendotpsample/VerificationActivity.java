...
public class VerificationActivity extends AppCompatActivity implements
    ...
    void initiateVerification(boolean skipPermissionCheck) {
        ...
        if (intent != null) {
            String phoneNumber = intent.getStringExtra(PhoneVerification.INTENT_PHONENUMBER);
            String countryCode = intent.getStringExtra(PhoneVerification.INTENT_COUNTRY_CODE);
